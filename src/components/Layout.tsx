...
import {
  ...
  Menu,
  X,
  Settings as SettingsIcon, // Using this for the logo
  Palette,
  Eraser
} from 'lucide-react';
    ...
    <div className="flex h-screen bg-surface-container-high md:bg-surface text-surface-on overflow-hidden font-sans">
      ...
      <nav className="hidden md:flex flex-col w-[280px] shrink-0 p-4 h-full">
        <div className="px-5 py-5 flex items-center gap-3">
          {/* UPDATED LOGO: Settings Icon */}
          <div className="w-11 h-11 rounded-m3-lg bg-primary flex items-center justify-center shadow-m3-1 text-white">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-20 pt-2 bg-surface z-40 flex items-center justify-between px-6 shadow-sm">
        <div className="flex items-center gap-3">
          {/* UPDATED LOGO: Settings Icon (Mobile) */}
          <div className="w-9 h-9 rounded-m3-sm bg-primary flex items-center justify-center shadow-sm text-white">
